                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="/product/detailProduct/${data.id }" class="link-to-product">
                                                    <img src= "${pageContext.request.contextPath}/templates/assets/images/${data.image}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                                <b class="categories">${data.category.name}</b>
                                                ...
                                                <div class="slide-down-box">
                                                    <p class="message">${data.description}.</p>
                                                    <div class="buttons">
                                                        
                                                        <a onclick="addToCart('${data.id}')"  class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>add to cart</a>
